...
class CollapsibleStylable extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className={parentClassString.trim()} style={this.props.style}>
        <span
...
CollapsibleStylable.defaultProps = {
  transitionTime: 400,
  easing: "linear",
  open: false,
...
export default CollapsibleStylable;

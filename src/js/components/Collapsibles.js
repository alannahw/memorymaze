...
class Collapsibles extends Component {
  constructor(props) {
    ...
    this.continueOpenCollapsibles = this.continueOpenCollapsibles.bind(this);
  ...
  render() {
    ...
    // Don't render children until the first opening of the Collapsibles if lazy rendering is enabled
    var children =
...
Collapsibles.defaultProps = {
  ...
  easing: "linear",
  open: false,
  classParentString: "Collapsibles",
